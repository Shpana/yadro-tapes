...
public:
  MergeSortAlgorithm(std::unique_ptr<Tape>&& input,
            std::unique_ptr<Tape>&& output,
            std::unique_ptr<Tape>&& extra1,
            std::unique_ptr<Tape>&& extra2,
            size_t memory_limit)
...
private:
  ...
  std::unique_ptr<Tape> _extra1_tape;
  std::unique_ptr<Tape> _extra2_tape;
  std::array<std::unique_ptr<Tape>, 2> _extra_tapes;
